...
class column_manager_test extends advanced_testcase {
    ...
    public function test_sort_columns(): void {
        $neworder = $this->columnmanager->sort_columns($this->columns);
        shuffle($neworder);
     ...
     *
     */
    public function test_enabledisablecolumns(): void {
        $neworder = $this->columnmanager->sort_columns($this->columns);
        shuffle($neworder);
        set_columnbank_order::execute($neworder);
        $currentconfig = get_config('qbank_columnsortorder', 'enabledcol');
